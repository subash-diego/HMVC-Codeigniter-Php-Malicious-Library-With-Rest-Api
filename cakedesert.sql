...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 01, 2018 at 05:29 PM
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `getauth` (IN `mail` VARCHAR(255))  READS SQL DATA
SELECT * from cakedesertcustomers where email = mail$$
...
--
-- Table structure for table `cakedesertcategory`
--

CREATE TABLE `cakedesertcategory` (
...
--
-- Dumping data for table `cakedesertcategory`
--

INSERT INTO `cakedesertcategory` (`categoryId`, `alias`, `status`, `isDeleted`, `name`) VALUES
(1, 'cakes', 0, 0, 'Cakes'),
(2, 'cookies', 0, 0, 'Cookies'),
(3, 'chokoletes', 0, 0, 'Chokoletes'),
(4, 'breads', 0, 0, 'Breads'),
(5, 'snacks', 0, 0, 'Snacks'),
(6, 'sweets', 0, 0, 'Sweets'),
(7, 'spicy', 0, 0, 'Spicy'),
(8, 'cooldrinks', 0, 0, 'Cool Drinks'),
(9, 'hotdrinks', 0, 0, 'Hot Drinks');

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertcities`
--

CREATE TABLE `cakedesertcities` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cakedesertcities`
--

INSERT INTO `cakedesertcities` (`id`, `name`, `state_id`) VALUES
(1, 'Bombuflat', 1),
(2, 'Garacharma', 1),
(3, 'Port Blair', 1),
(4, 'Rangat', 1),
...
--
-- Table structure for table `cakedesertcountries`
--

CREATE TABLE `cakedesertcountries` (
  `id` int(11) NOT NULL,
...
--
-- Dumping data for table `cakedesertcountries`
--

INSERT INTO `cakedesertcountries` (`id`, `sortname`, `name`, `phonecode`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
--
-- Table structure for table `cakedesertcustomerlogin`
--

CREATE TABLE `cakedesertcustomerlogin` (
...
--
-- Dumping data for table `cakedesertcustomerlogin`
--

INSERT INTO `cakedesertcustomerlogin` (`customerLoginId`, `customerId`, `loggedIn`, `loggedOut`, `accessToken`) VALUES
(1, '2', '2017-12-03 01:31:56', '2017-12-03 01:41:50', 'a2048fb7fb67b85ce1b1cb3249050462'),
(2, '2', '2018-01-07 06:42:16', '2018-01-07 06:43:36', 'fe571ad94283037c20ff8b4b2556f6a9'),
(3, '2', '2018-01-07 06:43:54', '2018-01-07 06:44:07', '3445a7558086e063a6ec851d582c526e'),
(4, '2', '2018-01-07 06:46:05', '2018-01-07 06:46:09', '565f9a8fe4292acc2d06343038766e4e'),
(5, '2', '2018-02-04 01:23:54', NULL, 'bcc2ee9ca644631761da7d292c978248');

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertcustomers`
--

CREATE TABLE `cakedesertcustomers` (
...
--
-- Dumping data for table `cakedesertcustomers`
--

INSERT INTO `cakedesertcustomers` (`customerId`, `firstName`, `lastName`, `email`, `password`, `website`, `mobilenumber`, `picture`, `action`, `isDeleted`, `status`, `terms`) VALUES
(2, 'subash', 'chandar', 'subash.diego@gmail.com', 'c30f834bc165cd6751837b87da9e82f7f66986d1', NULL, NULL, NULL, NULL, 0, 0, NULL),
(3, 'subash', 'chandar', 'subashchandar@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, NULL, NULL, NULL, 0, 0, 'on'),
(4, 'subash', 'chandar', 'subashchand@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, NULL, NULL, NULL, 0, 0, 'on'),
(5, 'ilavarasan', 'R', 'ila@gmail.com', '7c4a8d09ca3762af61e59520943dc26494f8941b', NULL, NULL, NULL, NULL, 0, 0, 'on'),
(6, 'Malik', 'basha', 'maikmech121@gmail.com', '01b307acba4f54f55aafc33bb06bbbf6ca803e9a', NULL, NULL, NULL, NULL, 0, 0, 'on'),
(7, 'jawaher', 'p', 'jawaher@gmail.com', 'dd6093ccdd47f06562c5b48a5e0a97244aa88460', NULL, NULL, NULL, NULL, 0, 0, NULL);

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertforgotpassword`
--

CREATE TABLE `cakedesertforgotpassword` (
...
--
-- Table structure for table `cakedeserthometopbanner`
--

CREATE TABLE `cakedeserthometopbanner` (
  `homeTopBannerId` int(11) NOT NULL,
  `homePageType` varchar(255) NOT NULL,
  `name` varchar(255) NOT NULL,
  `actionUrl` text NOT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  `isDeleted` int(11) NOT NULL DEFAULT '0',
  `header` text NOT NULL,
  `smallHeader` text NOT NULL,
  `picture` varchar(255) NOT NULL,
  `createdDate` date NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `cakedeserthometopbanner`
--

INSERT INTO `cakedeserthometopbanner` (`homeTopBannerId`, `homePageType`, `name`, `actionUrl`, `status`, `isDeleted`, `header`, `smallHeader`, `picture`, `createdDate`) VALUES
(1, '1', 'hola', '', 1, 0, 'subash chandar', '', 'hometop.jpg', '2017-11-08'),
(2, '2', 'subash', 'http://www.google.com', 1, 0, 'hi subash chandar', 'chanfafkfnl   jlnskvnv fkjjgnfskn', 'WRlSQL0Iwgs8rYnu.jpg', '2017-11-08'),
(3, '1', 'chandar', 'http://www.google.com', 0, 0, 'hi subash', 'hi chandar', 'AVJUbwNWXa3GCFkt.jpg', '0000-00-00'),
(4, '3', 'deepak', 'http://www.google.com', 1, 0, 'kjnlk', 'khkjb', '1hPZJFEwng4svKG3.jpg', '2017-11-13'),
(5, '1', 'subash chandar offers cakes for diwali', 'http://www.cakedesert.com/admin', 1, 0, 'Get Delicious cakes get 50% off', 'Hurry On cakedesert ', 'bEXewCDHFdfYSOA1.jpg', '2017-11-16'),
(6, '2', 'hilay', 'http://www.google.com', 1, 0, 'huh', 'kjhk', 'zOlbS0KqZE8GDap7.jpg', '2017-11-17');

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertloginactivity`
--

CREATE TABLE `cakedesertloginactivity` (
...
--
-- Dumping data for table `cakedesertloginactivity`
--

INSERT INTO `cakedesertloginactivity` (`loginActivityId`, `userId`, `loggedIn`, `loggedOut`, `accessToken`) VALUES
(1, '1', '2017-10-06 01:59:48', '2017-10-06 02:01:10', '245a1a937cd17196f7e99df7d8b8525a'),
(2, '1', '2017-10-06 02:01:30', '2017-10-06 02:02:12', '7397e4bd433da7e254bfd66cffd4697f'),
(3, '1', '2017-10-06 01:32:41', NULL, 'c3f70e4dd5d843bf6046a59406f77dac'),
(4, '1', '2017-10-16 02:20:47', '2017-10-16 02:20:55', 'd479da6246248c501634db0c2d07346b'),
(5, '1', '2017-10-25 10:44:26', NULL, '69513c94bc4cf07a7e564f0cdc2f52c2'),
(6, '1', '2017-11-06 01:40:26', '2017-11-06 01:41:56', '35e10e0837ebf653174f8e0f89b0a73a'),
(7, '1', '2017-11-08 02:05:58', NULL, '3bfab0cf2ec0623f1501957ee2082198'),
(8, '1', '2017-11-08 03:25:36', '2017-11-08 04:17:02', '2b119a126c7235f7db4525733b381039'),
(9, '1', '2017-11-08 04:17:14', '2017-11-08 04:25:15', 'ee5534c6ac23c7dc6e21749d52d5f73e'),
(10, '1', '2017-11-08 04:25:25', '2017-11-08 04:26:22', 'a79fa69ac61d441a52bd9234a7e0a415'),
(11, '1', '2017-11-08 04:26:32', '2017-11-08 04:39:30', 'f5cd17468f3119b579d0bdd3a4f75e66'),
(12, '1', '2017-11-08 04:39:41', '2017-11-08 04:39:47', 'e96dc38b02d603bd0164e59eb8ed91c1'),
(13, '1', '2017-11-08 04:40:17', '2017-11-08 04:41:24', '0812d88a2512884a208a7ad5314dd75f'),
(14, '1', '2017-11-08 04:41:34', '2017-11-08 04:43:40', 'ddb9738340d682c6730ded2152df1e27'),
(15, '1', '2017-11-08 04:43:53', '2017-11-08 04:45:42', 'd2cbae7ee3a7916fab04b1623ee97652'),
(16, '1', '2017-11-08 04:45:52', '2017-11-08 05:06:21', 'a0b3b043ed277f2c616675de1e057a80'),
(17, '1', '2017-11-08 05:06:30', NULL, '96d13cb9f6544d80c6fcadd568918671'),
(18, '1', '2017-11-08 07:14:26', NULL, 'ef9fa567bb862250f7ef0104cb7c66c2'),
(19, '1', '2017-11-09 03:39:12', NULL, '8f06afdf217c0fbffe501d2fa2e1bd77'),
(20, '1', '2017-11-13 01:48:18', NULL, '78407ff9e494b6b8a556778d36d25fa3'),
(21, '1', '2017-11-13 10:17:18', NULL, '4f9e5f4d0f03418634050524f4bcade7'),
(22, '1', '2017-11-13 10:43:34', NULL, '0fede03669e305879f391aaaabc55b85'),
(23, '1', '2017-11-13 10:49:04', '2017-11-13 10:50:24', '2f368491240755a242036720cdd7c686'),
(24, '1', '2017-11-13 10:59:41', NULL, 'a338818a3431f2dab5cb89ff491fbfa7'),
(25, '1', '2017-11-14 07:40:45', NULL, 'f78f56d18869c0cc242d8182d53dce6f'),
(26, '1', '2017-11-16 10:39:38', NULL, 'ce583b1291ca728a05e5c723004bd0c7'),
(27, '1', '2017-11-16 11:24:59', '2017-11-17 12:07:06', '4981dc819bb5b6b2bae3fd6f29a8ea00'),
(28, '1', '2017-11-17 06:05:56', '2017-11-17 06:51:38', '9d88c65bb39e400dd20799b342e36ed7'),
(29, '1', '2017-11-17 06:51:47', NULL, '2465801d3a85ecb057db1b930f0c14cc'),
(30, '1', '2017-11-19 01:04:50', NULL, '2c1ade8e6fd6c39c6725bee482a76850'),
(31, '1', '2017-11-19 03:56:09', NULL, '74956c818b6f0a7ed5701aa2a856523b'),
(32, '1', '2017-11-19 05:43:04', NULL, '7423eaeaa37bd657712429b44a397139'),
(33, '1', '2017-11-19 11:13:58', NULL, 'e389b43b38d88b6aeec6d3d9fbd9eb03'),
(34, '1', '2017-11-21 09:24:42', NULL, '356fdbf8ec30e1b45d39f6a192ff8be3'),
(35, '1', '2017-11-28 09:02:06', NULL, '1dbf899d2e70d2dc4877eb406757ee63'),
(36, '1', '2017-11-28 09:59:33', '2017-11-28 11:30:13', '301003e753d5e5e5bacfb328a3c32a64'),
(37, '1', '2017-11-30 10:46:10', NULL, '918a575c91d7ed3fa78e45085e19abd6'),
(38, '1', '2017-12-02 08:44:19', NULL, '4cd841c976c2d722c1b3b587b7ecf80a'),
(39, '1', '2017-12-03 01:16:26', NULL, 'cc1307eac7b371f3e400411b699814be'),
(40, '1', '2018-01-24 08:55:11', NULL, '68cf50c7782f5e13069e3626087d3feb'),
(41, '1', '2018-02-04 01:24:46', NULL, 'eabf3e1a3fade68830059bb9225e569f');

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertmailtemplate`
--

CREATE TABLE `cakedesertmailtemplate` (
...
--
-- Dumping data for table `cakedesertmailtemplate`
--

INSERT INTO `cakedesertmailtemplate` (`mailTemplateId`, `name`, `data`, `status`, `isDeleted`) VALUES
(1, 'forgot', '\r\n<!DOCTYPE html>\r\n<html>\r\n\r\n<head>\r\n    <meta charset=\"UTF-8\">\r\n    <meta content=\"width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no\" name=\"viewport\">\r\n    <title>Sign In | cake Desert</title>\r\n    <!-- Favicon-->\r\n    <link rel=\"icon\" href=\"favicon.ico\" type=\"image/x-icon\">\r\n\r\n    <!-- Google Fonts -->\r\n    <link href=\"https://fonts.googleapis.com/css?family=Roboto:400,700&subset=latin,cyrillic-ext\" rel=\"stylesheet\" type=\"text/css\">\r\n    <link href=\"https://fonts.googleapis.com/icon?family=Material+Icons\" rel=\"stylesheet\" type=\"text/css\">\r\n\r\n    <!-- Bootstrap Core Css -->\r\n    <link href=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/bootstrap/css/bootstrap.css\" rel=\"stylesheet\">\r\n\r\n    <!-- Waves Effect Css -->\r\n    <link href=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/node-waves/waves.css\" rel=\"stylesheet\" />\r\n\r\n    <!-- Animation Css -->\r\n    <link href=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/animate-css/animate.css\" rel=\"stylesheet\" />\r\n\r\n    <!-- Custom Css -->\r\n    <link href=\"http://www.cakedesert.com/assets/MainAsset/custom/css/style.css\" rel=\"stylesheet\">\r\n</head>\r\n\r\n<body class=\"login-page\">\r\n        <div class=\"login-box\">\r\n        <div class=\"logo\">\r\n            <a href=\"javascript:void(0);\">\r\n                <img src=\"http://www.cakedesert.com/assets/images/mainlogo.png\" alt=\"logo\">\r\n            </a>\r\n            <!-- <small>Admin BootStrap Based - Material Design</small> -->\r\n        </div>\r\n        <div class=\"card\">\r\n            <div class=\"body\">\r\n                <form id=\"forgot_password\" method=\"POST\" action=\"http://www.cakedesert.com/Login/forgotten\">\r\n                    <div class=\"msg\">\r\n                        Enter your email address that you used to register. We\'ll send you an email with your username and a\r\n                        link to reset your password.\r\n                    </div>\r\n                    <div class=\"input-group\">\r\n                        <span class=\"input-group-addon\">\r\n                            <i class=\"material-icons\">email</i>\r\n                        </span>\r\n                        <div class=\"form-line\">\r\n                            <input type=\"email\" class=\"form-control\" name=\"email\" placeholder=\"Email\" required autofocus>\r\n                        </div>\r\n                    </div>\r\n\r\n                    <button class=\"btn btn-block btn-lg bg-pink waves-effect\" type=\"submit\">RESET MY PASSWORD</button>\r\n\r\n                    <div class=\"row m-t-20 m-b--5 align-center\">\r\n                        <a href=\"http://www.cakedesert.com/Login\">Sign In!</a>\r\n                    </div>\r\n                </form>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    \r\n\r\n    <!-- Jquery Core Js -->\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/jquery/jquery.min.js\"></script>\r\n\r\n    <!-- Bootstrap Core Js -->\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/bootstrap/js/bootstrap.js\"></script>\r\n\r\n    <!-- Waves Effect Plugin Js -->\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/node-waves/waves.js\"></script>\r\n\r\n    <!-- Validation Plugin Js -->\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/plugins/jquery-validation/jquery.validate.js\"></script>\r\n\r\n    <!-- Custom Js -->\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/js/admin.js\"></script>\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/js/pages/examples/forgot-password.js\"></script>\r\n\r\n    <script src=\"http://www.cakedesert.com/assets/MainAsset/custom/js/pages/ui/notifications.js\"></script>\r\n\r\n</body>\r\n\r\n</html>\r\n\r\n<style type=\"text/css\">\r\n    body{\r\n        background-color: #ffffff !important;\r\n    }\r\n</style>', 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertmainbanner`
--

CREATE TABLE `cakedesertmainbanner` (
  `mainBannerId` int(11) NOT NULL,
  `header` text NOT NULL,
  `smallheader` text NOT NULL,
  `name` varchar(255) NOT NULL,
  `picture` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cakedesertmainbanner`
--

INSERT INTO `cakedesertmainbanner` (`mainBannerId`, `header`, `smallheader`, `name`, `picture`, `isDeleted`, `status`, `actionurl`, `createdDate`) VALUES
(1, 'subash chandar', 'hi subash', 'hola', 'help.jpg', 0, 0, 'llll', '2017-11-18'),
(3, '2nd', 'yhgfh', 'gladiator', 'cWh4IwHKQSgxsnel.jpg', 0, 0, 'http://www.google.com', '2017-11-12'),
(4, 'eghjk', 'hgnfjhfgj', 'fjybhvjgv', 'jf0A6HXmBSIwqn27.jpg', 0, 0, 'http://www.google.com', '2017-11-19'),
(5, 'yurtjut', 'utruyrt', 'gl', 'qd9QO65YIiRxNLH8.jpg', 0, 0, 'http://www.google.com', '2017-11-19'),
(6, 'uytfuyjtf', 'ytfuy6ft', 'jfjhfg', 'Zl3haICJKrDn0kNu.jpg', 0, 0, 'http://www.google.com', '2017-11-19');

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertmetadata`
--

CREATE TABLE `cakedesertmetadata` (
...
--
-- Dumping data for table `cakedesertmetadata`
--

INSERT INTO `cakedesertmetadata` (`metadataId`, `alias`, `url`, `title`, `description`, `keywords`, `author`, `viewport`, `isDeleted`) VALUES
(1, 'Home', 'home', 'homepage', 'subash,chandar', 'hi,da,subash', 'subashchandar', NULL, 0),
(2, 'subash', 'subash', 'welcome to cakedesert', 'hello dash f***k stupid', 'welcome,subash,double', 'subaash chandar', NULL, 0),
(3, 'homepage', 'homepage', 'homepage', 'this is homepage', 'subash chan,wow,dig', 'subash', NULL, 0),
(4, 'main', 'main', 'welcome to cakedesert', 'welcome to cakedesert', 'cake,cookies,juice', 'subash chandar', NULL, 0);
...
--
-- Table structure for table `cakedesertstates`
--

CREATE TABLE `cakedesertstates` (
  `id` int(11) NOT NULL,
  `name` varchar(30) NOT NULL,
...
--
-- Dumping data for table `cakedesertstates`
--

INSERT INTO `cakedesertstates` (`id`, `name`, `country_id`) VALUES
...
--
-- Table structure for table `cakedesertsubcategory`
--

CREATE TABLE `cakedesertsubcategory` (
...
--
-- Dumping data for table `cakedesertsubcategory`
--

INSERT INTO `cakedesertsubcategory` (`subcategoryId`, `alias`, `name`, `categoryId`, `status`, `isDeleted`) VALUES
(1, 'birthdaycakes', 'Birthday Cakes', 1, 0, 0),
(2, 'anniversarycakes', 'Anniversary Cake', 1, 0, 0),
(3, 'lovecakes', 'Love Cakes', 1, 0, 0),
(4, 'kidscakes', 'Kids Cakes', 1, 0, 0),
(5, 'cupcakes', 'Cup Cakes', 1, 0, 0),
(6, 'plaincakes', 'Plain Cakes', 1, 0, 0),
(7, 'applejuice', 'Apple Juice', 8, 0, 0),
(8, 'orangejuice', 'Orange Juice', 8, 0, 0);

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertuser`
--

CREATE TABLE `cakedesertuser` (
  `userid` int(11) NOT NULL,
  `firstname` varchar(255) NOT NULL,
  `lastname` varchar(255) NOT NULL,
  `email` varchar(255) NOT NULL,
...
--
-- Dumping data for table `cakedesertuser`
--

INSERT INTO `cakedesertuser` (`userid`, `firstname`, `lastname`, `email`, `password`, `website`, `mobilenumber`, `picture`, `action`, `is_deleted`, `is_status`, `address`, `role`, `inserted_date`, `updated_on`, `inserted_by`) VALUES
(2, 'subash', 'chandar', 'subash.diego@gmail.com', 'c30f834bc165cd6751837b87da9e82f7f66986d1', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, '2018-02-28 00:00:00', '2018-02-28 17:30:43', 'subash'),
(3, 'jawaher', 'p', 'jawaher@gmail.com', 'dd6093ccdd47f06562c5b48a5e0a97244aa88460', NULL, NULL, NULL, NULL, 0, 0, NULL, NULL, '2018-02-28 08:15:01', '2018-02-28 19:15:01', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `cakedesertuser_tracking`
--

CREATE TABLE `cakedesertuser_tracking` (
...
--
-- Dumping data for table `cakedesertuser_tracking`
--

INSERT INTO `cakedesertuser_tracking` (`track_id`, `token`, `userid`, `framework_token`, `created_on`, `browser`, `operating_system`, `expired_to`, `ip`, `updated_on`) VALUES
(0, '283d6c79e147e617879909d76fb7143a', 2, '1519839608', '2018-02-28 06:44:49', 'Chrome', 'Windows 7', '2018-03-01 18:45:39', '::1', '2018-02-28 18:45:39');
...
--
-- Indexes for table `cakedesertcategory`
--
ALTER TABLE `cakedesertcategory`
  ADD PRIMARY KEY (`categoryId`);

--
-- Indexes for table `cakedesertcities`
--
ALTER TABLE `cakedesertcities`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cakedesertcountries`
--
ALTER TABLE `cakedesertcountries`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cakedesertcustomerlogin`
--
ALTER TABLE `cakedesertcustomerlogin`
  ADD PRIMARY KEY (`customerLoginId`);

--
-- Indexes for table `cakedesertcustomers`
--
ALTER TABLE `cakedesertcustomers`
  ADD PRIMARY KEY (`customerId`);

--
-- Indexes for table `cakedesertforgotpassword`
--
ALTER TABLE `cakedesertforgotpassword`
  ADD PRIMARY KEY (`forgotPasswordId`);

--
-- Indexes for table `cakedeserthometopbanner`
--
ALTER TABLE `cakedeserthometopbanner`
  ADD PRIMARY KEY (`homeTopBannerId`);

--
-- Indexes for table `cakedesertloginactivity`
--
ALTER TABLE `cakedesertloginactivity`
  ADD PRIMARY KEY (`loginActivityId`);

--
-- Indexes for table `cakedesertmailtemplate`
--
ALTER TABLE `cakedesertmailtemplate`
  ADD PRIMARY KEY (`mailTemplateId`);

--
-- Indexes for table `cakedesertmainbanner`
--
ALTER TABLE `cakedesertmainbanner`
  ADD PRIMARY KEY (`mainBannerId`);

--
-- Indexes for table `cakedesertmetadata`
--
ALTER TABLE `cakedesertmetadata`
  ADD PRIMARY KEY (`metadataId`);

--
-- Indexes for table `cakedesertstates`
--
ALTER TABLE `cakedesertstates`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `cakedesertsubcategory`
--
ALTER TABLE `cakedesertsubcategory`
  ADD PRIMARY KEY (`subcategoryId`);

--
-- Indexes for table `cakedesertuser`
--
ALTER TABLE `cakedesertuser`
...
--
-- AUTO_INCREMENT for table `cakedesertcategory`
--
ALTER TABLE `cakedesertcategory`
  MODIFY `categoryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `cakedesertcities`
--
ALTER TABLE `cakedesertcities`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5742;

--
-- AUTO_INCREMENT for table `cakedesertcountries`
--
ALTER TABLE `cakedesertcountries`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=247;

--
-- AUTO_INCREMENT for table `cakedesertcustomerlogin`
--
ALTER TABLE `cakedesertcustomerlogin`
  MODIFY `customerLoginId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `cakedesertcustomers`
--
ALTER TABLE `cakedesertcustomers`
  MODIFY `customerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `cakedesertforgotpassword`
--
ALTER TABLE `cakedesertforgotpassword`
  MODIFY `forgotPasswordId` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `cakedeserthometopbanner`
--
ALTER TABLE `cakedeserthometopbanner`
  MODIFY `homeTopBannerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `cakedesertloginactivity`
--
ALTER TABLE `cakedesertloginactivity`
  MODIFY `loginActivityId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `cakedesertmailtemplate`
--
ALTER TABLE `cakedesertmailtemplate`
  MODIFY `mailTemplateId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `cakedesertmainbanner`
--
ALTER TABLE `cakedesertmainbanner`
  MODIFY `mainBannerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `cakedesertmetadata`
--
ALTER TABLE `cakedesertmetadata`
  MODIFY `metadataId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `cakedesertstates`
--
ALTER TABLE `cakedesertstates`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=42;

--
-- AUTO_INCREMENT for table `cakedesertsubcategory`
--
ALTER TABLE `cakedesertsubcategory`
  MODIFY `subcategoryId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `cakedesertuser`
--
ALTER TABLE `cakedesertuser`
